...
<style type="text/css">
	...
	<div class="container" id="app">
		<div class="form-surat border-bottom text-center">
			<h2 class="border-bottom label-primary"><strong>Membuat Surat Keterangan Penghasilan</strong></h2>
			<div class="row">
				<div class="col-md-3"></div>
				<div class="col-md-6">
					<h2 class="text-center"><strong>Data Penduduk</strong></h2>
					<i><p class="text-warning">Untuk Membuat Surat Keterangan Penghasilan Isi Semua Form Berikut</p></i> <br>
					<form class="form-horizontal" action="keterangan_penghasilan.php" method="GET" target="_blank">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-4 text-left" for="penghasilan">penghasilan</label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" name="penghasilan" id="penghasilan" v-model="penghasilan" placeholder="">
					    </div>
					  </div>
					  <div class="form-group">
					    <label class="control-label col-sm-4 text-left" for="penghasilan_terbilang">penghasilan terbilang</label>
					    <div class="col-sm-8">
					      <input type="text" class="form-control" name="penghasilan_terbilang" id="penghasilan_terbilang" v-model="penghasilan_terbilang" placeholder="">
					    </div>
					  </div>
					  <div class="form-group">
...
<script type="text/javascript">
	var data = {
		...
		nama: 'SURYANINGSIH',
		nama_desa: 'Bengkel',
		tempat_lahir: 'Gelogor',
		tgl_lahir: '31-12-1978',
		nik: 5201087112780216,
		jenis_kelamin: 'Perempuan',
		agama: 'Islam',
		pekerjaan: 'Pedagang',
		penghasilan: '500.000- 1.000.000',
		penghasilan_terbilang: 'Lima Ratus Ribu Rupiah Sampai Satu Juta Ribu Rupiah',
		alamat: 'Dusun Bengkel Selatan Rt 01 , Desa Bengkel, Kecamatan Labuapi, Kabupaten Lombok Barat',
